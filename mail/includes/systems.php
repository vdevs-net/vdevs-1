...
if ($mod == 'clear') {
    ...
    if ($total) {
        ...
        if ($total > $kmess) {
            $out .= '<div class="topmenu">' . functions::display_pagination('index.php?act=systems&page=', $start, $total, $kmess) . '</div>';
        }
...
echo '<a href="' . SITE_URL . '/users/profile.php?act=office">' . $lng['personal'] . '</a></p>';
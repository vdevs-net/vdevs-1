    ...
    default:
        ...
        if ($total) {
            ...
            while ($res = mysql_fetch_assoc($req)) {
                ...
                // If you have set the font style, then apply
                ...
                ////////////////////////////////////////////////////////////
                echo '<p><img src="' . SITE_URL . '/images/' . ($res['to'] ? 'red' : 'green') . '.gif" width="16" height="16" class="left"/>&#160;' .
                ...
                // If there was agreement, the output description
                if ($agreement) {
        ...
        if ($total > $kmess) {
            echo '<div class="topmenu">' . functions::display_pagination('index.php?act=ads&type=' . $type . '&page=', $start, $total, $kmess) . '</div>' .

...
switch ($mod) {
    ...
    default:
        ...
        */
        ...
        if ($total > $kmess) echo'<div class="topmenu">' . functions::display_pagination('index.php?act=reg&page=', $start, $total, $kmess) . '</div>';
        if ($total) {
        ...
        if ($total > $kmess) {
            echo'<div class="topmenu">' . functions::display_pagination('index.php?act=reg&page=', $start, $total, $kmess) . '</div>' .
